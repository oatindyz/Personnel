        ...
        public static UOC_STAFF GetOUC_STAFF(string CITIZEN_ID)
        {
            ...
            using (OracleConnection con = new OracleConnection(CONNECTION_STRING))
            {
                ...
                using (OracleCommand com = new OracleCommand(
                   ...
                   "ZIPCODE," +
                   "NATION_ID," +
                   "(SELECT NATION_NAME_TH FROM REF_NATION WHERE REF_NATION.NATION_ID = UOC_STAFF.NATION_ID) NATION_NAME," +
                   "STAFFTYPE_ID," +
                   ...
                   "GRAD_UNIV," +
                   "GRAD_COUNTRY_ID," +
                   "(SELECT NATION_NAME_TH FROM REF_NATION WHERE REF_NATION.NATION_ID = UOC_STAFF.GRAD_COUNTRY_ID) GRAD_COUNTRY_NAME," +
                   "DEFORM_ID," +
