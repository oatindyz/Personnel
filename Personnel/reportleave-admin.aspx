<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="reportleave-admin.aspx.cs" Inherits="Personnel.reportleave_admin" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="default_page_style">
        <div class="ps-header">
            <img src="Image/Small/copy.png" />รายงาน การลาออก
        </div>
                ...
                <div class="panel-body">
                    <div style="text-align: center;">
                        ...
                        <tr>
                            <td>ประเภทบุคลากร</td>
                            <td>
                                <asp:DropDownList ID="ddlStafftype" runat="server" CssClass="form-control select2"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>สังกัด</td>
                        ...
                        <tr>
                            <td>ประเภทการดำรงตำแหน่งปัจจุบัน</td>
                            <td>
                                <asp:DropDownList ID="ddlMovementType" runat="server" CssClass="form-control select2"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>วันที่มีผลบังคับใช้ตามข้อมูล"การเข้าสู่ตำแหน่งปัจจุบัน"</td>
                            <td>
