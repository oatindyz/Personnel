<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="previewuser-admin.aspx.cs" Inherits="Personnel.previewuser_admin" %>
                ...
                <div id="divLoad1" runat="server" class="dataTable_wrapper" style="width: 100%; margin: auto;">
                    <div class="panel panel-default">
                            <table class="table table-striped table-bordered table-hover" style="width: 100%;">
                                <tr>
                                    <td class="col1" style="width: 250px;">รหัสประจำตัวประชาชน</td>
                                    <td class="col2">
                                        <asp:Label ID="lbCitizenID" runat="server"></asp:Label>
                                    </td>
                                    <td class="col1" style="width: 250px;">ประเภทบุคลากร</td>
                                    <td class="col2">
                                        <asp:Label ID="lbStaffType" runat="server"></asp:Label>
                                    </td>
                                     <td class="col1" style="width: 300px;">ความพิการ</td>
                                    <td class="col2">
