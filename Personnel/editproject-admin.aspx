<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="editproject-admin.aspx.cs" Inherits="Personnel.editproject_admin" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="default_page_style">
        <div class="ps-header">
            ...
            <span style="text-align:right; float:right;"><a href="listproject-admin.aspx">
